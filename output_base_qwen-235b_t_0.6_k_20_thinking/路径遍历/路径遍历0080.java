...
public class FileCipher {
    ...
    private static void encryptFile(String filePath) throws IOException {
        ...
        try (FileInputStream in = new FileInputStream(inputFile);
            ...
            while ((data = in.read()) != -1) {
                out.write(data ^ ENCRYPTION_KEY.hashCode());
            }
        }
        System.out.println("加密完成，文件保存为: " + encryptedFile.getAbsolutePath());
    }
    ...
    private static void decryptFile(String filePath) throws IOException {
        ...
        System.out.println("解密完成，文件保存为: " + outputFile.getAbsolutePath());
    }
}